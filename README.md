...
ARP Lab is coded in Python and is best run using either the *Jupyter Lab* or *jupyter* notebook. Therefore, I recommend installing *Anaconda* on your computer. It can be found at anaconda.com. Follow the instruction on the web site to install anaconda on your computer.
