...
BondsBaa = [
    ...
    # 1980
    -3.32, 8.46, 29.05, 16.19, 15.62, 23.86, 21.35, 2.81, 14.38, 15.95,
    # 1990
    6.28, 18.93, 11.31, 15.47, -0.97, 21.29, 3.42, 12.75, 7.63, 0.91,
    # 2000
    9.39, 8.54, 12.14, 12.32, 10.35, 5.30, 5.20, 4.84, -3.54, 20.21,
    # 2010
    9.41, 12.26, 9.33, -0.98, 10.78, -1.50, 11.52, 9.23, -3.27, 15.25,
    # 2020
    10.60, 0.93, -15.14, 8.74
    ]
...
BondsAaa = [
    ...
    # 1980
    -2.55, 7.94, 27.89, 7.85, 14.80, 25.97, 18.95, -0.85, 12.87, 14.39,
    # 1990
    7.72, 14.98, 9.84, 14.30, -2.78, 21.16, 2.83, 11.26, 10.20, -3.39,
    # 2000
    10.99, 11.09, 10.42, 9.54, 7.14, 6.73, 3.75, 5.84, 10.97, -0.09,
    # 2010
    8.83, 13.99, 4.59, -3.43, 11.56, 1.13, 4.53, 8.40, -0.93, 12.08,
    # 2020
    10.23, -1.93, -12.88, 5.09
    ]
...
Inflation = [
    ...
    # 1940
    0.71, 9.93, 9.03, 2.96, 2.30, 2.25, 18.13, 8.84, 2.73, -1.83,
    # 1950
    5.80, 5.96, 0.91, 0.60, -0.37, 0.37, 2.83, 3.04, 1.76, 1.52,
    # 1960
    1.36, 0.67, 1.23, 1.65, 1.20, 1.92, 3.36, 3.28, 4.71, 5.90,
    # 1970
    5.57, 3.27, 3.41, 8.94, 12.10, 7.13, 5.04, 6.68, 8.99, 13.25,
    # 1980
    12.35, 8.91, 3.83, 3.79, 4.04, 3.79, 1.19, 4.33, 4.41, 4.64,
    # 1990
    6.25, 2.98, 2.97, 2.81, 2.60, 2.53, 3.38, 1.70, 1.61, 2.68,
    # 2000
    3.44, 1.60, 2.48, 2.04, 3.34, 3.34, 2.52, 4.11, -0.02, 2.81,
    # 2010
    1.44, 3.06, 1.76, 1.51, 0.65, 0.64, 2.05, 2.13, 2.00, 2.31,
    # 2020
    1.32, 7.19, 6.44, 3.12
    ]
